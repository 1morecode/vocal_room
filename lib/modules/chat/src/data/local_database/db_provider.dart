...
import 'package:vocal/modules/chat/src/data/local_database/message_table.dart';
import 'package:vocal/modules/chat/src/data/local_database/user_table.dart';
...
class DBProvider {
  ...
  Future<UserModel> getUser(String id) async {
    ...
    ''');
    if (users.length > 0) {
      return UserModel.fromLocalDatabaseMap(users.first);
    }
    return null;
  }
