...
import 'package:vocal/modules/chat/src/screens/contact/contact_controller.dart';
import 'package:vocal/modules/chat/src/utils/dates.dart';
import 'package:vocal/modules/chat/src/widgets/custom_app_bar.dart';
import 'package:vocal/modules/chat/src/widgets/text_field_with_button.dart';
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          "${_contactController.selectedChat.user.picture}",
                          fit: BoxFit.cover,
                        ),
                      ),
                      radius: 16,
      ...
      return Row(
        children: <Widget>[
          ...
          Text(
            ...
            style: TextStyle(color: colorScheme.secondaryVariant, fontSize: 10),
          ),
        ],
      );
    }
        ...
        Container(
          ...
          child: Padding(
            ...
            child: Text(
              day,
              style:
                  TextStyle(color: colorScheme.secondaryVariant, fontSize: 12),
            ),
          ),
        ),
        SizedBox(
