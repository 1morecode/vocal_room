...
import 'package:vocal/modules/chat/src/utils/custom_shared_preferences.dart';
import 'package:vocal/modules/chat/src/utils/socket_controller.dart';
import 'package:vocal/modules/chat/src/utils/state_control.dart';

class ChatHomeController extends StateControl with WidgetsBindingObserver {
  ...
  void emitUserIn() async {
    UserModel user = await CustomSharedPreferences.getMyUser();
